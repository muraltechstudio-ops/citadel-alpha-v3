...
const totalWins = trades.filter(t => t.s === "win").length
              ...
              <tbody>
                {filteredTrades.map((trade, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-right text-sm text-[#FEFEFE]/60 whitespace-nowrap">${trade.en}</td>
                    <td className="px-4 py-2.5 text-right text-sm text-[#FEFEFE]/60 whitespace-nowrap">${trade.ex}</td>
                    <td className={`px-4 py-2.5 text-right text-sm font-semibold whitespace-nowrap ${trade.s === "win" ? "text-[#10B981]" : "text-[#EF4444]"}`}>
                      <span className="flex items-center justify-end space-x-1">
                        {trade.s === "win" ? <TrendingUp size={12} /> : <TrendingDown size={12} />}
                        <span>{trade.r}</span>
                      </span>
                    </td>
                  </motion.tr>
